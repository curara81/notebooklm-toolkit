...
> 💡 **워크플로:** 회의 중 아이폰/맥북 음성 메모로 녹음 → 맥북으로 파일 전송 → 이 스크립트 실행.
>
> 📱⌚️ **애플워치 버튼으로 녹음을 시작/정지하고 자동으로 회의록까지 만드는 iOS + watchOS 앱**도 포함되어 있습니다 → [`apple-watch-app/`](apple-watch-app/README.md)
